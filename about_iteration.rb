...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # it takes a initical value x and perform the operation indicated on it with
    # the first element of the array, the result is now is the new value of x and 
    # the operation is applied with the next element of the array.
  end
